...
import com.keimons.nutshell.exception.NutshellConfigException;
...
public class NutshellConfig {
	 ...
	 * 日志路径
	 */
	public static final String LOG_PATH = "nutshell.log.path";
	 ...
	 * 是否调试模式运行
	 */
	public static final String DEBUG = "nutshell.debug";
	 ...
	 * 是否启用控制台重定向
	 */
	public static final String CONSOLE_REDIRECT = "nutshell.console.redirect";
	 ...
	 * 是否自适应逻辑处理线程级别
	 */
	public static final String NET_THREAD_AUTO = "nutshell.net.thread.auto";
	 ...
	 * 端口号
	 */
	public static final String NET_PORT = "nutshell.net.port";
	 ...
	 * 线程数量
	 */
	public static final String NET_THREAD_COUNT = "nutshell.net.thread.count";
	 ...
	 * 多级线程池
	 */
	public static final String NET_THREAD_LEVEL = "nutshell.net.thread.level";
	 ...
	 * 多级线程池
	 */
	public static final String NET_THREAD_SIMPLE = "nutshell.net.thread.simple";
	 ...
	 * @param config 配置文件
	 */
	public NutshellConfig(Properties config) {
		String property;
		// 是否Debug模式运行
		...
		if (netThreadCount[0] == 0) {
			throw new NutshellConfigException(NET_THREAD_COUNT);
		}
		...
		// 端口号
		property = config.getProperty(NET_PORT, DEFAULT_NET_POTR);
	 ...
	 * @return 系统配置
	 */
	public static NutshellConfig defaultConfig() {
		return new NutshellConfig(new Properties());
	}
	...
	public static class KeimonsConfigBuilder {
		 ...
		 * @return 配置文件
		 */
		public NutshellConfig build() {
			NutshellConfig config = new NutshellConfig();
			config.debug = debug;
